...
import com.nammamela.app.di.AppModule_ProvideCategoryDaoFactory;
...
import com.nammamela.app.viewmodel.AuthViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.nammamela.app.viewmodel.ManagerViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.nammamela.app.viewmodel.NotificationViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNammaMelaApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends NammaMelaApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.castViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.fanWallViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      this.homeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
      this.manageCastViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
      this.managerViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.myBookingsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 8: // com.nammamela.app.data.local.dao.NotificationDao 
          return (T) AppModule_ProvideNotificationDaoFactory.provideNotificationDao(singletonCImpl.provideAppDatabaseProvider.get());
