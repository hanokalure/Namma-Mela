...
public final class AppRepositoryImpl_Factory implements Factory<AppRepositoryImpl> {
  ...
  public AppRepositoryImpl get() {
    return newInstance(playDaoProvider.get(), actorDaoProvider.get(), seatDaoProvider.get(), commentDaoProvider.get(), bookingDaoProvider.get(), userDaoProvider.get());
  }
  ...
  public static AppRepositoryImpl_Factory create(Provider<PlayDao> playDaoProvider,
      ...
      Provider<CommentDao> commentDaoProvider, Provider<BookingDao> bookingDaoProvider,
      Provider<UserDao> userDaoProvider) {
    return new AppRepositoryImpl_Factory(playDaoProvider, actorDaoProvider, seatDaoProvider, commentDaoProvider, bookingDaoProvider, userDaoProvider);
  }
  ...
  public static AppRepositoryImpl newInstance(PlayDao playDao, ActorDao actorDao, SeatDao seatDao,
    ...
    return new AppRepositoryImpl(playDao, actorDao, seatDao, commentDao, bookingDao, userDao);
  }
}
