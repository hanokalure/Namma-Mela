...
public final class NotificationDao_Impl implements NotificationDao {
  ...
  public NotificationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNotification = new EntityInsertionAdapter<Notification>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notifications` (`id`,`userId`,`title`,`message`,`type`,`timestamp`,`isRead`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public List<Notification> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsRead = _tmp != 0;
            _item = new Notification(_tmpId,_tmpUserId,_tmpTitle,_tmpMessage,_tmpType,_tmpTimestamp,_tmpIsRead);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Notification>> getNotificationsForUser(final int userId) {
